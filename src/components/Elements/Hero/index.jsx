...
function Hero() {
  return (
    <div className="grid lg:grid-cols-4 grid-cols-2 gap-4 px-5 lg:px-20 place-content-center ">
      ...
      <div className="lg:col-span-2 lg:row-span-2 bg-[url('/src/assets/grid-2-2.jpg')] bg-cover bg-bottom lg:bg-right-top rounded-xl p-5 lg:p-20 flex flex-col justify-center items-start shadow-xl ">
